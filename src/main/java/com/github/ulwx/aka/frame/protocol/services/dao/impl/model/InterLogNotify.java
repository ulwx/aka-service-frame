package com.github.ulwx.aka.frame.protocol.services.dao.impl.model;
...
***********************************************/
public class InterLogNotify  implements java.io.Serializable {

	private Long id;/*流水号;len:20*/
	private String requestNo;/*请求流水号;len:30*/
	private String serviceName;/*接口名称;len:50*/
	private String responseType;/*回调类型：NOTIFY , CALLBACK，LF_CALLBACK;len:20*/
	private String reqCode;/*reqCode区分接口逻辑，[ver]_[moduleName]_[cparseCode]_[callType]_[serviceName]_[extStr]_[infKey] 。callType：1-异步回调 2-网关回调 3-本地窗体;len:100*/
	private Long logid;/*日志id;len:19*/
	private String className;/*处理类名;len:50*/
	private String platformNo;/*平台编码;len:30*/
	private String platformUserNo;/*平台用户id;len:30*/
	private String respData;/*通知的数据体;len:2000*/
	...
	private static final long serialVersionUID =2061888602L;
