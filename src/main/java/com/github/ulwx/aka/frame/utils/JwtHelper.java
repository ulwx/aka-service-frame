...
public class JwtHelper {
    ...
    public static String createJWT(TokenInfo jwtInfo, String jwtKey, int expireSeconds) {
    ...
    public static TokenInfo parseJWT(String jwtToken, String jwtKey) throws Exception {
