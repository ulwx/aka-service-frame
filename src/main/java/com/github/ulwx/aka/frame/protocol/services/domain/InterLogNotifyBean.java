package com.github.ulwx.aka.frame.protocol.services.domain;
import java.time.*;
...
***********************************************/
public class InterLogNotifyBean implements java.io.Serializable {

	private Long id;/*流水号;len:20*/
	private String requestNo;/*请求流水号;len:30*/
	private String serviceName;/*接口名称;len:30*/
	private String reqCode;/*请求code，根据此code区分请求插件类型;len:100*/
